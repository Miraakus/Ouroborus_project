...
History.COMMANDS = [];
/**The current command index within the vector of undoable objects. At that position there will be a Command*/
...
/**Pack identical commands into a single, equivalent command.
