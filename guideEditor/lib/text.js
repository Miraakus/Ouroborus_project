 ...
 * Right now all the texts are horizontally and vertically centered so the (x,y) is the center of the text
 * @this {Text}
 * @constructor
 ...
 * @see list of web safe fonts : <a href="http://www.ampsoft.net/webdesign-l/WindowsMacFonts.html">http://www.ampsoft.net/webdesign-l/WindowsMacFonts.html</a> Arial, Verdana </p>
 * @see /documents/specs/text.png <p/>
 * Note:<br/>
...
Text.load = function(o){
    ...
    //x loaded by constructor
    //y loaded by constructor
    //size loaded by constructor
    //font loaded by constructor
    //newText.lineSpacing = o.lineSpacing; //automatic computed from text size
    //align loaded by constructor
...
Text.prototype = {
    ...
    /**
     *Get a reference to a context (main, in our case)
    ...
    /**Transform the Text
     *Upon transformation the vector is transformed but the text remains the same.
    ...
    /**
     *Get the angle around the compass between the vector and North direction
